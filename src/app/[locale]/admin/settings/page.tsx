...
export default function AdminSettingsClient() {
  ...
  useEffect(() => {
    fetch("/api/admin/settings/cancellation")
      .then((r) => r.json())
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardTitle>Cancellation Terms & Conditions</CardTitle>
        <CardDescription>Editable content used in the platform.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {loading ? (
          <div className="animate-shimmer h-32 rounded-xl bg-[var(--surface-mid)]" />
        ) : (
        ...
        <Button
          ...
          onClick={async () => {
            setSaving(true);
            await fetch("/api/admin/settings/cancellation", {
              method: "PUT",
